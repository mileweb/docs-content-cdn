...
```
2. Do not use this directive to set the `Host` header to origin, instead, use the "origins.hostHeader" field of [the property JSON](/cdn/apidocs#operation/createPropertyVersion). Otherwise you will get validation error.
