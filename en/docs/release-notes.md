...
* Removed the API key from the response of the Get customer API. For security, the key will only be returned when the customer is created or the key is reset.
