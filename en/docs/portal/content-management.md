...
CDN360 supports prefix purging. Using this feature, you can purge something as small as a file or as large as entire files and subdirectories by entering values in the <strong>Add a file to be purged</strong> and <strong>Add a directory to be purged</strong> fields. The following table shows prefix purging examples.
