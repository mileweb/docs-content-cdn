...
| Role Status          | Select between **Local** and **Remote**: <br><ul><li><strong>Local</strong> = only this customer account can use this role.</br></ul></li><ul><li><strong>Remote</strong> = all customers can use this role.</ul></li> |
