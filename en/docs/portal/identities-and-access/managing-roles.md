...
| Role Status          | Allows resellers to specify the status of this role. Choices are: <ul><li>Local = only this customer account can use this role.</ul></li><ul><li>Global = all customers can use this role.</ul></li>|
