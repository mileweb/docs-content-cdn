...
3. Scroll down to the **Deployment** section, select either **Staging** or **Production** from the **Deployment Destination** drop-down list, and click the appropriate button:<ul><li>To deploy the property now, click **Deploy Now** and proceed to the next step.</ul></li><ul><li>To deploy the property at a later time, click <strong>Add to Standby task</strong> to move this action to the [standby queue](</docs/portal/certificates/managing-standby-tasks.md>).</ul></li> 
...
2. When the confirmation pop-up appears, click the appropriate button:<ul><li>To undeploy the property now, click **OK** and proceed to the next step.</ul></li><ul><li>To undeploy the property at a later time, click <strong>Add to Standby task</strong> to move this action to the [standby queue](</docs/portal/certificates/managing-standby-tasks.md>).</ul></li>   
