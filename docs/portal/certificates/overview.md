...
|2|The list of all certificates that are available to you. Click the **+** sign to see which properties are using each certificate, and whether the properties are in the staging or production environment.|
