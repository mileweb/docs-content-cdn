...
2. On the Properties page, click the **Actions** menu of the property whose version you want to compare, and then select **Compare Versions**, OR

If you are already on the property details page click the <strong>Compare Versions</strong> button.</ul>
