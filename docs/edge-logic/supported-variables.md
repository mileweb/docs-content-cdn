...
| ---- | ---- | ---- | ---- |
| [$arg*](http://nginx.org/en/docs/http/ngx_http_core_module.html#var_arg) | one query parameter | <span class="badge green">TRUE</span> | <span class="badge green">TRUE</span> |
