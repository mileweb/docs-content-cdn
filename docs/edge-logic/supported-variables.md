...
| ---- | ---- | ---- | ---- |
| [$arg_*](http://nginx.org/en/docs/http/ngx_http_core_module.html#var_arg_) | one query parameter | <span class="badge green">TRUE</span> | <span class="badge green">TRUE</span> |
