...
* When slicing is enabled, the server automatically removes the `Accept-Encoding` header in the request to origin to disable compression. You should not use 'origin_set_header' to override this behavior, otherwise the response may be corrupted.
