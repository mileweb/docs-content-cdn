...
| Authentication Certificate        |Select a certificate you want to use to authenticate with the origin server. The certificate must be created and deployed like other certificates. Because this certificate is used to connect to your origin server, you would typically upload your own certificate instead of creating a CDN Pro auto-renewed certificate.</ul>|
