...
当生产中使用的证书接近其到期日期时，CDN Pro 会发送电子邮件通知。为方便起见，CDN Pro 支持通过 [Let's Encrypt](<https://letsencrypt.org/zh-cn/docs/challenge-types/> ) 来实现证书的 [自动更新](</docs/portal/certificates/auto-renewal.md>) ，因此您无需担心证书会过期。如果您更喜欢手动更新证书，请选择以下两个操作步骤之一。
