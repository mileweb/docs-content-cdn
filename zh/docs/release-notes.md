...
### API updates
* Disallowed update of the edgeHostname field in edge hostnames because it can cause service interruptions.
...
* Improved display of lengthier tooltip in the property configuration page.
* Fixed issues supporting Russian translation.
* Added clarification for trial users that deployment to production is enabled only after they’ve done some tests against staging.
