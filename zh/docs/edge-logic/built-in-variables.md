...
| <span id="tcpinfo_min_rtt"></span><span class="var">$tcpinfo_min_rtt</span> |<span class="badge small" title="numerical value">#</span> 本次请求中统计到的最小RTT, 单位为微妙 | <span class="badge yellow">No</span> | <span class="badge green">Yes</span> |
| <span id="tcpinfo_rtt"></span><span class="var">$tcpinfo_rtt</span> |<span class="badge small" title="numerical value">#</span> 本次请求中统计到的最后一次RTT, 单位为微妙 | <span class="badge yellow">No</span> | <span class="badge green">Yes</span> |
